...
const Penyelamatan = () => {
    ...
    const getDataFromAirtable = async () => {
      ...
      const addData = async (newData) => {
        try {
          ...
          const response = await axios.post(
            `https://api.airtable.com/v0/appXAxP37CyOjn5HX/tbpenyelamatan`,
            sendData,
            config
          );
          ...
          const fixData = {
            ...
            Kronologi: responseData.fields.Kronologi,
      ...
      const removeData = async (id) => {
        try {
          const axiosParams = {
            method: "delete",
            url: `https://api.airtable.com/v0/appXAxP37CyOjn5HX/tbpenyelamatan/${id}`,
            headers: {
              Authorization: "Bearer key3b2Iv6kflbqQug",
              "Content-Type": "application/json",
            },
    ...
    const {Grup_Jaga, Hari_dan_Tanggal, Sumber_Informasi, Nama_Pelapor, Alamat_Kejadian, Objek, Korban, Kondisi_Korban, Identitas_Korban, Nama_Perwira_Piket, Nama_Komandan_Insiden, Pengerahan_Unit, Pengerahan_Personil, Jam_Mulai, Jam_Selesai, Kronologi, Tindakan_Petugas, Upload_Dokumentasi} = form;
  ...
  return (
    ...
    <div className="row">
        ...
        <div className="form-group mb-1 col-12">
            ...
            <input name="Nama_Pelapor" className="form-control" value={Nama_Pelapor} onChange={onChange}></input>
        </div>

        <div className="form-group mb-1 col-12">
            <label>Alamat Kejadian</label>
            <textarea name="Alamat_Kejadian" className="form-control" value={Alamat_Kejadian} onChange={onChange}></textarea>
        </div>
        ...
        <div className="form-group mb-1 col-12">
            <label>Korban</label>
            <select name="Korban" className="form-control" value={Korban} onChange={onChange}>
                <option value="">Pilih</option>
        ...
        <div className="form-group mb-1 col-12">
            ...
            <select name="Kondisi_Korban" className="form-control" value={Kondisi_Korban} onChange={onChange}>
                <option value="">Pilih</option>
        ...
        <div className="form-group mb-1 col-12">
            ...
            <input name="Identitas_Korban" className="form-control" value={Identitas_Korban} onChange={onChange}></input>
        </div>
        ...
        <div className="form-group mb-1 col-12">
            ...
            <select name="Nama_Komandan_Insiden" className="form-control" value={Nama_Komandan_Insiden} onChange={onChange}>
		      <option value="">Pilih</option>
		      {dataAnggota?.map((item, index) => {
   			return (
       		<option key={index} value={item.fields.Nama} >{item.fields.Nama}</option>
        ...
        <div className="form-group mb-1 col-12">
            ...
            <textarea name="Kronologi" className="form-control" value={Kronologi} onChange={onChange}></textarea>
        </div>

        <div className="form-group mb-1 col-12">
            <label>Tindakan Petugas</label>
            <textarea name="Tindakan_Petugas" className="form-control"></textarea>
        </div>
